...
my $projectroot = '/home/idexcc12/domains/administracion.idex.cc/public_html/git';
...
my $snapshots_url = 'http://administracion.idex.cc/git';
my $git_base_url = 'http://administracion.idex.cc/git';
